<div class="col-xs-12 item-row margin-top-5">
    <div class="@if($invoiceSetting->hsn_sac_code_show) col-md-3 @else col-md-4 @endif ">
        <div class="row">
    ...
    @if($invoiceSetting->hsn_sac_code_show)
        <div class="col-md-1">
            ...
            <input type="text" class="form-control" value="{{ $items->hsn_sac_code }}" data-item-id="{{ $items->id }}"  name="hsn_sac_code[]" >
