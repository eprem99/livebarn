...
<div class="r-panel-body p-t-0">
    ...
    <div class="row">
        <div class="col-xs-12 col-md-9 p-t-20 b-r h-scroll">
            ...
            <div class="col-xs-12">
                <a class="btn btn-default btn-sm m-b-10 btn-rounded btn-outline pull-right m-l-5" href="{{ route('admin.all-tasks.download-task', $task->id) }}"> <span><i class="fa fa-file-pdf-o"></i></span> </a>
                ...
                <a href="javascript:;" id="inCompletedButton" class="btn btn-default btn-outline btn-sm m-b-10 btn-rounded @if($task->board_column->slug != 'completed') hidden @endif"  onclick="markComplete('closed')"><i class="fa fa-times"></i> @lang('modules.tasks.markClosed')</a>
...
<script>
    ...
    $('body').on('click', '.file-edit', function () {
        ...
        var url = "{{ route('admin.task-files.updates',':id') }}";
            url = url.replace(':id', id);
    ...
    $('#dounload-zip').click(function () {
        var files = [],
            ...
            url = "{{ route('admin.task-files.alldownloadzip',':id') }}",
            token = "{{ csrf_token() }}";
            url = url.replace(':id', id);
